...
class CentroidTracker():
    ...
    def update(self, rects):
        ...
        # intialize an array of input centroids for the current frame
        ...
        # otherwise, are are currently tracking objects so we need to try to match the input centroids to existing object
		# centroids
        else:
            ...
            # loop over the combination of the (rows, column) index tuples
